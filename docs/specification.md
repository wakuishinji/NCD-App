...
## 🎓 資格情報画面（clinicQualifications.html）
- **役割**: 資格情報の一覧・追加

- **入力項目**
  - 資格名（必須, 30文字以内, 全角/半角可）
  - 説明（任意, 100文字以内）
...
- **入力項目（AI設定）**
  - モデル名（必須, 半角英数字・ハイフン, 例: gpt-4o-mini）
  - systemプロンプト（任意, 最大1000文字）

- **バリデーション**
  - モデル名が空欄ならエラー
  - モデル名が `gpt-` で始まらない場合は警告
  - systemプロンプトは空でも可
