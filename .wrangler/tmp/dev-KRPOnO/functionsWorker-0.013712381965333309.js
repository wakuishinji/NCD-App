...
// .wrangler/tmp/pages-dEkfkf/functionsWorker-0.013712381965333309.mjs
...
async function onRequest(context) {
  ...
  function normalizeKey(type, category, name) {
    const zenkakuToHankaku = /* @__PURE__ */ __name2((s) => s.normalize("NFKC"), "zenkakuToHankaku");
    const clean = /* @__PURE__ */ __name2((s) => zenkakuToHankaku((s || "").trim().toLowerCase().replace(/\s+/g, "")), "clean");
  ...
  __name2(normalizeForSimilarity, "normalizeForSimilarity");
  ...
  __name2(jaroWinkler, "jaroWinkler");
  ...
  __name2(getClinicByName, "getClinicByName");
  ...
  __name2(listClinicsKV, "listClinicsKV");
  ...
  __name2(normalizeTodoEntry, "normalizeTodoEntry");
...
// .wrangler/tmp/bundle-99lZ1i/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-99lZ1i/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.013712381965333309.js.map
